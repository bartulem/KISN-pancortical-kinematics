...
class CrossValidation(object):
    ...
    def partition_data(self, y):
        ...
        Description
        ----------
        This method partitions the data for K-Fold cross-validation.
        ----------
        ...
        method (str)
            Cand be "block", "random", or "sublock".
            e.g. in "sublock", a sub-fold of each big fold will be chosen to form a fold.

        n_repeat (int)
            If not None, the cross-validation will be re-run for n_repeat times.
            Each time with a new folding scheme.
        ----------
        ...
        ----------
        fold_index (list)
            The index of fold for each observation. e.g. if observations
            1,4,5 in fold 2, and observations 2,3,6 in fold 1,
    ...
    def cv(self, y, x):
        ...
        Description
        ----------
        This method performs cross-validation for a particular model.
        ----------
